...
# Hi there, I'm Tarun Gurugubelli 👋

**Full Stack Developer · MEAN Stack · DevOps Enthusiast**
...
I'm a Full Stack Developer at **Infosys** specializing in the **MEAN stack** — Angular, Node.js, MongoDB, and MySQL — with additional experience in Python and TypeScript. I build end-to-end web applications and integrate DevOps tooling (Jenkins, Docker, Kubernetes) to ship reliable, scalable software.

- 🔭 Currently building production-grade applications on the MEAN stack
- 🛠️ Experienced with CI/CD pipelines, containerization, and cloud-ready deployments
- 🌱 Exploring FastAPI, TailwindCSS, and data engineering with Pandas & NumPy
- 💬 Ask me about Angular, Node.js, REST APIs, or DevOps workflows
